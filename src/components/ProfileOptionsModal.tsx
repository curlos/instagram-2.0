...
const ProfileOptionsModal = ({ open, setOpen }: Props) => {
  ...
  return (
    open ? (
      <StyledModal>
        ...
        <StyledModalContent>
          <StyledOption color={'red'}>Block this user</StyledOption>
          <StyledOption color={'red'}>Restrict</StyledOption>
          <StyledOption color={'red'}>Report User</StyledOption>
